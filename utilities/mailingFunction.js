...
function ResetPassword(userId) {
    ...
    <body>
        <div class="container">
            ...
            <p>Thank you,<br>The SkyTrails PVT. LTD. Team</p>
        </div>
    </body>
    </html>`;
}
...
module.exports = {flightMail, busMail, hotelMail, otpMail, welcomeMail,welcomeAgentMail ,ssdcMail, packageLandingMail,hotelGrnMail,ResetPassword, SubAdminResetPassword};