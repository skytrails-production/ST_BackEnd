...
const kafilaFlightBookingData = require("../model/flightBookingKafila.model");
...
exports.kafilaFlightBooking = async (req, res) => {
  try {
    const data = {
      ...req.body,
      bookingStatus: "BOOKED",
    };
    const response = await kafilaFlightBookingData.create(data);
    const msg = "flight booking details added successfully";
