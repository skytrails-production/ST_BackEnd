...
module.exports = function (app) {
    ...
    app.post('/skyTrails/forumPost/postLikes',[authJwt.verifcationToken],controller.postLike);
    app.post('/skyTrails/forumPost/likePost',[authJwt.verifcationToken],controller.likePost)
}
