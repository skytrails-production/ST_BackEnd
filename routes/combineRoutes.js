...
module.exports = function (app) {
  ...
  app.get('/skyTrails/api/amadeus/user/getAllBookingHistoryAggregate',[authJwt.verifcationToken],combineBookingDetailsCOntroller.getCombineFlightBookingRespAggregate)
};
